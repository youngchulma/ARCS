...
public class User extends BaseModel<User> {
	 ...
	 * 字段类型：character varying  长度：100
	 */
	public static final String column_aes = "aes";
	
	/**
	 * 字段描述：AES加密向量
	 * 字段类型：character varying  长度：100
	 */
	public static final String column_aesvector = "aesvector";
	
	/**
	 * 字段描述：RSA加密公钥 
	 * 字段类型：character varying  长度：500
	 */
	public static final String column_rsapublic = "rsapublic";

	/**
	 * 字段描述：RSA加密私钥
	 * 字段类型：character varying  长度：1500
	 */
	public static final String column_rsaprivate = "rsaprivate";
	...
	public String getIdea() {
		return get(column_idea);
	}
	public void setIdea(String idea) {
		set(column_idea, idea);
	}
	public String getAes() {
		return get(column_aes);
	}
	public void setAes(String aes) {
		set(column_aes, aes);
	}
	public String getAesvector() {
		return get(column_aesvector);
	}
	public void setAesvector(String aesvector) {
		set(column_aesvector, aesvector);
	}
	public String getRsapublic() {
		return get(column_rsapublic);
	}
	public void setRsapublic(String rsapublic) {
		set(column_rsapublic, rsapublic);
	}
	public String getRsaprivate() {
		return get(column_rsaprivate);
	}
	public void setRsaprivate(String rsaprivate) {
		set(column_rsaprivate, rsaprivate);
	}
