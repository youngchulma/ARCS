...
public interface ConstantInit {
	 ...
	 * IDEA加密密钥
	 */
	public static final String config_securityKey_idea = "config.securityKey.idea";

	/**
	 * RSA加密公钥
	 */
	public static final String config_securityKey_rsa_public = "config.securityKey.rsa.public";

	/**
	 * RSA加密私钥
	 */
	public static final String config_securityKey_rsa_private = "config.securityKey.rsa.private";
