...
public abstract class Controller {
	...
	public void renderFile(String fileName, String downloadSaveFileName) {
		render = renderManager.getRenderFactory().getFileRender(fileName, downloadSaveFileName);
	}
	...
	public void renderFile(File file, String downloadSaveFileName) {
		render = renderManager.getRenderFactory().getFileRender(file, downloadSaveFileName);
	}
