...
public class Db {
	...
	static Page<Record> paginate(Config config, Connection conn, int pageNumber, int pageSize, String select, String selectCount, String sqlExceptSelect, Object... paras) throws SQLException {
		return DbPro.MAIN.paginate(config, conn, pageNumber, pageSize, select, selectCount, sqlExceptSelect, paras);
	}
	 ...
	 */
	public static Page<Record> paginate(int pageNumber, int pageSize, String select, String selectCount, String sqlExceptSelect, Object... paras) {
		return DbPro.MAIN.paginate(pageNumber, pageSize, select, selectCount, sqlExceptSelect, paras);
	}
	
	public static Page<Record> paginate(int pageNumber, int pageSize, boolean isGroupBySql, String select, String selectCount, String sqlExceptSelect, Object... paras) {
		return DbPro.MAIN.paginate(pageNumber, pageSize, isGroupBySql, select, selectCount, sqlExceptSelect, paras);
	}
	
	/**
	 * @see #paginate(String, int, int, String, String, Object...)
	 */
	public static Page<Record> paginate(int pageNumber, int pageSize, String select, String selectCount, String sqlExceptSelect) {
		return DbPro.MAIN.paginate(pageNumber, pageSize, select, selectCount, sqlExceptSelect);
	}
	 ...
	 * @return Page
	 */
	public static Page<Record> paginateByCache(String cacheName, Object key, int pageNumber, int pageSize, String select, String selectCount, String sqlExceptSelect, Object... paras) {
		return DbPro.MAIN.paginateByCache(cacheName, key, pageNumber, pageSize, select, selectCount, sqlExceptSelect, paras);
	}
	
	public static Page<Record> paginateByCache(String cacheName, Object key, int pageNumber, int pageSize, boolean isGroupBySql, String select, String selectCount, String sqlExceptSelect, Object... paras) {
		return DbPro.MAIN.paginateByCache(cacheName, key, pageNumber, pageSize, isGroupBySql, select, selectCount, sqlExceptSelect, paras);
	}
	
	/**
	 * @see #paginateByCache(String, Object, int, int, String, String, Object...)
	 */
	public static Page<Record> paginateByCache(String cacheName, Object key, int pageNumber, int pageSize, String select, String selectCount, String sqlExceptSelect) {
		return DbPro.MAIN.paginateByCache(cacheName, key, pageNumber, pageSize, select, selectCount, sqlExceptSelect);
	}
